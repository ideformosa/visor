  ...
  function initApp() {
    _app = new gxp.Viewer({
      ...
      tools: [
        ...
        {
          ptype: 'gxp_print',
          printService: 'https://idef.formosa.gob.ar/servicios/pdf/',
          includeLegend: true,
          showButtonText: true,
          actionTarget: 'map.tbar'
        },
        ...
        {
          actions: [
            '<a href="https://idef.formosa.gob.ar/?q=contact" \
        ...
        {
          actions: [
            '<a href="https://github.com/ideformosa/visor" \
  ...
  function _addExtraControls() {
    _app.on('ready', function () {
      ...
      treeTbar.addButton({
        ...
        text: 'Metadatos',
        tooltip:
          'Vea más información acerca de la capa seleccionada (fechas, ' +
    ...
    _app.on('ready', function () {
      ...
      tree.on('click', function (node, e) {
        if (node.isLeaf()) {
          ...
          if (
            _app.selectedLayer.data.metadataURLs &&
      ...
      btnMetadatos.on('click', function (button, e) {
        ...
        new Ext.Window({
          ...
          html:
            '<iframe src ="' +
            _app.selectedLayer.data.metadataURLs[0].href +
